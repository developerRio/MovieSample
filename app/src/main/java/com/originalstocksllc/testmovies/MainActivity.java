...
public class MainActivity extends AppCompatActivity {
    ...
    private int itemsCount = 10, startingItemsCount = 10;
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if (!isLoading && (totalItemCount - visibleItemCount) <= (pastVisibleItems + viewThreshold)) {
                        ...
                        isLoading = true;
                        Toast.makeText(MainActivity.this, "Loading more movies...", Toast.LENGTH_SHORT).show();
                        itemsCount = itemsCount + 10;
                        Log.i(TAG, "onScrolled_startingItemsCount = " + startingItemsCount + "\n" + "itemsCount = " + itemsCount);
                        loadMoviesData(startingItemsCount, itemsCount);
                        startingItemsCount = startingItemsCount + 10;
                    }
                }
            }
        };
        gridRecyclerView.addOnScrollListener(mOnScrollListener);
    ...
    private void loadMoviesData(final int startingItemsCount, final int nextItemsCount) {
        ...
        StringRequest rootStringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = startingItemsCount; i < nextItemsCount; i++) {
                        ...
                        setupRecyclerContent(moviesList);
                       // staggeredGridLayoutManager.scrollToPosition(itemsCount);
            ...
            public void onErrorResponse(VolleyError error) {
                if (error != null) {
                    ...
                    Log.e(TAG, "onErrorResponseMovies: " + error.getMessage());
                } else {
    ...
    private void setupRecyclerContent(final List<Movies> moviesList) {
        ...
        if (gridRecyclerView.getAdapter() != null) {
            ...
            Log.e(TAG, "setupRecyclerContent_adapter is Null" );
        }
